...
import { calculateDeliverdate } from "../../data/deliveryOprions.js";
...
export function renderOrderSummary() {
  ...
  js-cart-item-container-${matchItem.id}">
            ...
            <div class="cart-item-details-grid">
              ...
              <div class="cart-item-details">
                ...
                <div class="product-quantity js-product-quantity-${matchItem.id}">
                  ...
                  <span class="delete-quantity-link link-primary js-delete-link js-delete-link-${matchItem.id}" data-product-id="${cartItem.productId}">
                    Delete
                  </span>
                </div>
              </div>
